...
export const adminBookingService = {
    async bookAtCounter(adminEmail, selection) {
        ...
        const claimed = await bookingService.holdSeat(trip.id, selection.busNumber, selection.seatNumber, new Date(Date.now() + 60_000));
        if (!claimed) {
        ...
        await booking.save();
        await bookingService.confirmSeat(trip.id, selection.busNumber, selection.seatNumber);
        return {
...
//# sourceMappingURL=adminBookingService.js.map