 ...
 */
export const claimSeat = async (tripId, busNumber, seatNumber, heldUntil) => {
...
export const freeSeat = async (tripId, busNumber, seatNumber) => {
    await collection().updateOne({ _id: oid(tripId) }, {
        $set: {
 ...
 */
export const sellSeat = async (tripId, busNumber, seatNumber) => {
    await collection().updateOne({ _id: oid(tripId) }, {
        $set: {
            "bus.$[bus].seats.$[seat].status": true,
            "bus.$[bus].seats.$[seat].heldUntil": null,
 ...
 */
export const releaseLapsedHolds = async (now = new Date()) => {
...
//# sourceMappingURL=seatStore.js.map