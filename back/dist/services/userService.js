...
export const userService = {
    ...
    async updateProfile(currentEmail, input) {
        ...
        const updated = await User.findOneAndUpdate({ email: currentEmail }, { FName: input.FName, LName: input.LName, email: input.email }, { new: true, runValidators: true })
            .select(PUBLIC_FIELDS)
            .lean()
            .exec();
        if (!updated)
