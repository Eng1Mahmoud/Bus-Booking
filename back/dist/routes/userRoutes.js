...
router.put("/me/avatar", validate({ body: uploadAvatarSchema }), userController.updateAvatar);
// --- Administrative ---------------------------------------------------------
...
router.get("/", requireAdmin, validate({ query: listUsersQuerySchema }), userController.listAll);
router.delete("/:email", requireAdmin, validate({ params: emailParamSchema }), userController.remove);
