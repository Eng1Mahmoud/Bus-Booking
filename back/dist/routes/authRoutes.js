...
router.post("/register", mailLimiter, validate({ body: registerSchema }), authController.register);
router.post("/forgot-password", mailLimiter, validate({ body: forgotPasswordSchema }), authController.forgotPassword);
